  ...
  const cards = [
    {
      ...
      detailDescription:
        "The first project I did at OpenICT was creating a portfoliowebsite. I had never written one line of code before so I had no experience at all. In about 6 weeks put this website together by means of YouTube tutorials and small lessons from classmates.",
      ...
      <div className="projects-cards">
        {cards.map((card) => (
          <Card
            ...
            projectLocation={card.projectLocation}
            className={card.className}
            wowDelay={card.wowDelay}
          />
        ))}
      </div>
    </div>
